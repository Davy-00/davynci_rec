    ...
    <header className="h-14 shrink-0 flex items-center gap-6 px-6 border-b border-slate-200 dark:border-white/[0.05] bg-white/95 dark:bg-[#080810]/95 backdrop-blur-md sticky top-0 z-40">
      ...
      <Link href="/portal" className="flex items-center gap-2.5 shrink-0">
        ...
        <div className="leading-none">
          ...
          <p className="text-[9px] text-slate-400 dark:text-slate-600 font-medium tracking-[0.2em] uppercase">Jobs Portal</p>
        </div>
      </Link>
      ...
      <Link
        href="/"
        className="inline-flex items-center gap-1.5 text-[10px] text-slate-400 dark:text-slate-600 hover:text-slate-600 dark:hover:text-slate-400 font-medium tracking-wide transition-colors"
      >
