    ...
    <header className="h-14 shrink-0 flex items-center gap-6 px-6 border-b border-slate-200 dark:border-white/[0.05] bg-white/95 dark:bg-[#080810]/95 backdrop-blur-md sticky top-0 z-40">
      ...
      <Link href="/hr" className="flex items-center gap-2.5 shrink-0">
        ...
        <div className="leading-none">
          ...
          <p className="text-[9px] text-slate-400 dark:text-slate-600 font-medium tracking-[0.2em] uppercase">HR Dashboard</p>
        </div>
      </Link>
      ...
      <Link
        href="/portal"
        className="text-[10px] text-slate-400 dark:text-slate-600 hover:text-slate-600 dark:hover:text-slate-400 font-medium tracking-wide transition-colors"
      >
        ← Applicant Portal
      </Link>
      ...
      <button
        ...
        className="p-1.5 rounded-lg text-slate-500 dark:text-slate-600 hover:text-rose-400 hover:bg-rose-400/10 transition-colors disabled:opacity-40"
      >
      ...
      <button
        ...
        title="Sign out"
        className="p-1.5 rounded-lg text-slate-500 dark:text-slate-600 hover:text-slate-900 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/[0.05] transition-colors"
      >
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-[10px] text-slate-400 dark:text-slate-600 font-medium tracking-wide hidden sm:block">Gemini live</span>
      </div>
    </header>
  );
}
