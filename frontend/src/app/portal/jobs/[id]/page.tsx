  ...
  if (notFound || !job) {
    return (
      <div className="max-w-3xl mx-auto px-6 py-20 text-center">
        <p className="text-slate-700 dark:text-slate-400 text-sm font-semibold">Position not found</p>
        <Link
          href="/portal"
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="fade-rise">
        ...
        {/* Meta */}
        <div className="flex flex-wrap gap-4 text-xs text-slate-500 mb-8 pb-8 border-b border-slate-200 dark:border-white/[0.05]">
          {job.location && (
        ...
        <section className="mb-8">
          <h2 className="text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest mb-3">
            About this role
          </h2>
          ...
          <section className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {job.requirements.requiredSkills.map((skill) => (
                <span
                  key={skill}
                  className="text-[11px] text-cyan-700 dark:text-cyan-300/80 bg-cyan-500/10 dark:bg-cyan-400/[0.06] border border-cyan-500/20 dark:border-cyan-400/12 px-3 py-1 rounded-full font-medium"
                >
                  {skill}
                </span>
              ))}
          ...
          <section className="mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              {job.requirements.preferredSkills.map((skill) => (
                <span
                  key={skill}
                  className="text-[11px] text-amber-700 dark:text-amber-300/70 bg-amber-500/10 dark:bg-amber-400/[0.05] border border-amber-500/20 dark:border-amber-400/10 px-3 py-1 rounded-full font-medium"
                >
        ...
        <div className="pt-6 border-t border-slate-200 dark:border-white/[0.06]">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-900 dark:text-white text-sm font-bold px-8 py-3.5 rounded-2xl transition-all shadow-lg shadow-cyan-500/20"
          >
